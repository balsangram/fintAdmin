  ...
  return (
    <div className="">
            ...
            <table className="w-full mt-4 border text-sm">
                <thead className="bg-gray-100">
                    <tr>
                        <th className="text-left py-2 px-3">Debited To</th>
                        <th className="text-left py-2 px-3">Credited To</th>
                        <th className="text-left py-2 px-3">Balance</th>
                        <th className="text-right py-2 px-3">Payment Date</th>
                    </tr>
                </thead>
    ...
    filteredData.map((item) => (
      <tr key={item.id} className="border-t">
        <td className="py-2 px-3">
          {item.balance < 0 ? item.name : item.to_name || ''}
        </td>
        <td className="py-2 px-3 ">
          {item.balance >= 0 ? item.name : item.to_name || ''}
        </td>
        <td className="py-2 px-3">₹{Math.abs(item.balance).toFixed(2)}</td>
