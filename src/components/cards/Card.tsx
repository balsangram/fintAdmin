...
const Card: React.FC<CardProps> = ({ id, link, name, img, isFavorite, onFavoriteToggle }) => {
        ...
        <>
            ...
            >
                <div className="flex flex-row-reverse">
                    {isFavorite ? <FavoriteIcon className="text-red-500" onClick={handleFavoriteClick} /> : <FavoriteBorderIcon onClick={handleFavoriteClick} />}
                </div>
